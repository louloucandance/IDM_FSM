...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see fr.ice.m1.fsm.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(fsmEClass, fr.ice.m1.fsm.model.FSM.class, "FSM", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFSM_State(), this.getState(), null, "state", null, 0, -1, fr.ice.m1.fsm.model.FSM.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_Transition(), this.getTransition(), null, "transition", null, 0, -1,
				fr.ice.m1.fsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFSM_Name(), ecorePackage.getEString(), "name", null, 0, 1, fr.ice.m1.fsm.model.FSM.class,
		...
		initEClass(transitionEClass, Transition.class, "Transition", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTransition_To(), this.getState(), this.getState_Incoming(), "to", null, 0, 1,
